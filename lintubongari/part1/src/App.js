      ...
      if (taxonomyData !== undefined) {
        ...
        if (lahkopalat !== undefined) {
          ...
          if (taxonomyData.includes("Uhanalaisuusluokitus")) {
            ...
            window.alert(
              laji +
                "-lajista ei saatu täydellisiä tietoja luotua. Luodaan osittainen havainto."
            );
          }
        } else {
          window.alert(
        ...
        <BrowserRouter>
          <div>
            <ul className="links">
              ...
              <h1>Tervetuloa lintuharrastaja</h1>
            </ul>
